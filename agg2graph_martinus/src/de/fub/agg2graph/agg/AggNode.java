...
//	List<GPSSegment> serial = new ArrayList<GPSSegment>();
//	
//	public void serialize() {
//		GPSSegment segment = new GPSSegment();
//		segment.add(0, this);
//		//rollback
//		if(this.getIn().size() > 0) {
//			if(this.getIn().size() == 1)
//		}
//		if(this.getOut().size() > 0) {
//			
//		}	
//	}
//	
//	public AggNode goToIn() {
//		return null;
//	}
//	
//	public AggNode goToOut() {
//		return null;
//	}
}
