...
/**
 * Since the function of AttractionForce can't be solved in Java, the
 * value of the force will be generated in Matlab. This alternative
 * method is not accurate enough though.
 * @author Martinus
 *
 */
public class AttractionValue {
	...
	/**
	 * Mapping the distance to the force's value
	 * @param distance
	 * @return
	 */
	...
	/**
	 * Approximate the distance (ceiling or flooring)
	 * @param distance
	 * @return
	 */
