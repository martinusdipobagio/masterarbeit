...
public class CopyOfDefaultMergeHandler implements IMergeHandler {
	...
	public CopyOfDefaultMergeHandler() {
		// debugging
	...
	public CopyOfDefaultMergeHandler(AggContainer aggContainer) {
		this();
...
//			}
	...
	public IMergeHandler getCopy() {
		CopyOfDefaultMergeHandler object = new CopyOfDefaultMergeHandler();
