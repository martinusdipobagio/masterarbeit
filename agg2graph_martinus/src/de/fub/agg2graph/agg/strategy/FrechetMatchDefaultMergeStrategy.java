...
public class FrechetMatchDefaultMergeStrategy extends
	...
	public FrechetMatchDefaultMergeStrategy() {
...
//	private List<AggNode> gpsPointsExchange(List<GPSPoint> bestPath) {
//		AggNode currentNode;
//		for(int i = 0; i < bestPath.size(); i++) {
//			currentNode = bestPath.get(i);
//			for(GPSPoint internal : internalAggNodes) {
//				if(currentNode.getLat() == internal.getLat() && currentNode.getLon() == internal.getLon()) {
//					bestPath.remove(i);
//					bestPath.add(internal);
//					break;
//				}
//			}
//		}
