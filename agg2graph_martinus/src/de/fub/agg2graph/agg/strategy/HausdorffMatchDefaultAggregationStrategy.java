...
public class HausdorffMatchDefaultAggregationStrategy extends AbstractAggregationStrategy {
...
//			.getLogger("agg2graph.agg.hausdorff.strategy");
	...
	public HausdorffMatchDefaultAggregationStrategy() {
...
//						i++;
		...
		for (IMergeHandler match : matches) {
			if (!match.isEmpty()) {
//				System.out.println(match.getAggNodes(0));
//				System.out.println(match.getAggNodes(1));
//				System.out.println(match.getGpsPoints(0));
//				System.out.println(match.getGpsPoints(1));
				match.mergePoints();
			}
		}
