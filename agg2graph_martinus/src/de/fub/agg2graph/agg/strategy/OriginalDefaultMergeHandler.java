...
public class OriginalDefaultMergeHandler implements IMergeHandler {
	...
	public double minContinuationAngle = 45;//45
	// helper stuff
	...
	public double maxPointGhostDist = 10; //10 meters

	private double distance = 10;
	private AggNode beforeNode;

	public OriginalDefaultMergeHandler() {
		// debugging
	...
	public OriginalDefaultMergeHandler(AggContainer aggContainer) {
		this();
...
//		// add turns
	...
	public IMergeHandler getCopy() {
		OriginalDefaultMergeHandler object = new OriginalDefaultMergeHandler();
