...
//	public void deriveFromGPSEdge(GPSEdge ed) {
//		this.setFrom(new GPSPoint());
//		this.getFrom().setLat(ed.getFrom().getLat());
//		this.getFrom().setLon(ed.getFrom().getLon());
//		this.getFrom().setElevation(ed.getFrom().getElevation());
//		this.setTo(new GPSPoint());
//		this.getTo().setLat(ed.getTo().getLat());
//		this.getTo().setLon(ed.getTo().getLon());
//		this.getTo().setElevation(ed.getTo().getElevation());
//		this.setDistance(ed.getDistance());
//		this.numbers = 1;
//		this.threshold = (INITIAL_TRESHOLD);
//	}
//
//	public void cloneGPSEdge(GPSEdge ed) {
//		this.setFrom(new GPSPoint());
//		this.getFrom().setLat(ed.getFrom().getLat());
//		this.getFrom().setLon(ed.getFrom().getLon());
//		this.getFrom().setElevation(ed.getFrom().getElevation());
...
//		this.threshold = ed.getThreshold();
//	}
//
//	public GPSEdge Clone() {
//		GPSEdge n = new GPSEdge();
//		n.cloneGPSEdge(this);
//		return n;
//	}
}
