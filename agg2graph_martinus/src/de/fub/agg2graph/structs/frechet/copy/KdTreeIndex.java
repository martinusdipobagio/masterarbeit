...
/** Static KD-Tree with search of nearest neighbor, k-nearest-neighbors and points in axis aligned box.
 * 
 * Used basic implementation O(n log^2 n) recursive build with alternating selection of axis.
 * 
 * */
public class KdTreeIndex<L extends AggNode> implements SearchIndex<L> {
	...
	/** Defined axis comparators. Used in the sort step for sorting based on the axis. */
