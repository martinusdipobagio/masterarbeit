...
public class MergeEvaluationAutoTest {
	...
	public MergeEvaluationAutoTest(String name) throws IOException {
...
//		aggContainer = AggContainer.createContainer(new File("test/agg/" + name), aggStrategy, cacheStrategy);
		...
		List<String> fileList = FileList.readFile(fileListDirectory, fileListName2);
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		MergeEvaluationAutoTest autoTest = new MergeEvaluationAutoTest("Tinus");
