...
public class FrechetMatchAttractionMergeStrategyEval extends
	...
	public FrechetMatchAttractionMergeStrategyEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-FrechetMatchAttractionMerge.txt");
