...
public class FrechetMatchIterativeMergeStrategyEval extends
	...
	public FrechetMatchIterativeMergeStrategyEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-FrechetMatchIterativeMerge.txt");
