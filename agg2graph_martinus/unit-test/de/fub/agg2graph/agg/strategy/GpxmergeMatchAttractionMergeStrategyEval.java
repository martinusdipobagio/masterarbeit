...
public class GpxmergeMatchAttractionMergeStrategyEval extends
		AbstractAggregationStrategy {
	MyStatistic statistic;
	int counter = 1;

	public double maxPathDifference = 50;
	public double maxInitDistance = 17.5;
	 ...
	 */
	public GpxmergeMatchAttractionMergeStrategyEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-GPXMergeAttractionMerge.txt");
