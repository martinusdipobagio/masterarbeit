...
public class HausdorffMatchAttractionMergeStrategyEval extends
	...
	public double maxInitDistance = 25;//12.5
	...
	public HausdorffMatchAttractionMergeStrategyEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-HausdorffMatchAttractionMerge.txt");
