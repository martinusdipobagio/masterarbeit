...
public class HausdorffMatchDefaultMergeStrategyEval extends
	...
	public HausdorffMatchDefaultMergeStrategyEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-HausdorffMatchDefaultMerge.txt");
