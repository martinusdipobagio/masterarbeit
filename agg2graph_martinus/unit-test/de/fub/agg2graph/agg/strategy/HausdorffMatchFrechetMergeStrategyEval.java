...
public class HausdorffMatchFrechetMergeStrategyEval extends
	...
	public HausdorffMatchFrechetMergeStrategyEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-HausdorffMatchFrechetMerge.txt");
