...
public class HausdorffMatchIterativeMergeStrategyEval extends
	...
	public HausdorffMatchIterativeMergeStrategyEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-HausdorffMatchIterativeMerge.txt");
