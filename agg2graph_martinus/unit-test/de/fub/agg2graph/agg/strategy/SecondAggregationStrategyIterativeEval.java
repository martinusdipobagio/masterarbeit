...
public class SecondAggregationStrategyIterativeEval extends AbstractAggregationStrategy {
	 ...
	 */
	public SecondAggregationStrategyIterativeEval() {
		statistic = new MyStatistic(
				"test/exp/Evaluation-SecondMatchIterativeMerge.txt");
...
//						lastNodes.add(lastNode);
	...
	private boolean validate(GPSSegment segment, GPSSegment copySegment,
		...
		return bestAggResult.size() == 0 || bestTraceResult.size() == 0 ? false
				: true;
	}
