...
//	private final String paramListDirectory = "test/distance_merge_configuration/";	//Manually inserted
	private final String traceFilesDirectory = "test/input/mergeEval-trace/";		//Manually inserted
	private final String aggFilesDirectory = "test/input/mergeEval-map/";			//Manually inserted
...
//	private final String fileListName3 = "mergelist3.txt";
	...
	public MergeEvaluationAutoTest(String codeAgg, String fileListName) throws IOException {
		//Define Help Classes
		gpsFilter = new GPSFilter();
		gpsCleaner = new GPSCleaner();
		rdpf = new RamerDouglasPeuckerFilter(15);
		aggContainer = AggContainer.createContainer(new File("test/agg/" + "Merge"), codeAgg);
...
//		MergeEvaluationAutoTest autoTest = new MergeEvaluationAutoTest(args[0], args[1]);
		MergeEvaluationAutoTest autoTest = new MergeEvaluationAutoTest("C12Eval", "");
